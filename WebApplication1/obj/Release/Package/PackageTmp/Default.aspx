...
<body>
    ...
    <p style="height: 30px">
        <asp:Label ID="Label3" runat="server" BackColor="#00CCFF" BorderStyle="Dotted" 
            Text="CHC中洲廠成型機產能分析系統-恒耀工業股份有限公司製作"></asp:Label>
    </p>
        <asp:Panel ID="Panel5" runat="server" Height="36px" Width="180px">
            <asp:Label ID="Label_Yesterday_Number" runat="server" Text="昨天行數：尚未載入"></asp:Label>
            <br />
            <asp:Label ID="Label_Today_Number" runat="server" Text="今天行數：尚未載入"></asp:Label>
        </asp:Panel>
...
&nbsp;&nbsp;
    ...
    onselectedindexchanged="RadioBtn_Viewdetails_SelectedIndexChanged">
        ...
        <asp:Button ID="Btn_UpdateInformation" runat="server" 
            onclick="Btn_UpdateInformation_Click" Text="更新" style="height: 21px" />
    </asp:Panel>
    </p>
    <br />
    </form>
